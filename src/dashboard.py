...
<div class="stats">{stat_cards}</div><section class="main-grid" id="atlas"><div class="map-panel"><div class="panel-heading"><h2>{name}, along the Aven</h2><span class="pill">{season_for(state['day'])}</span></div>{colony_map}<div class="map-caption">Select a district to inspect its public works. Buildings reflect completed improvements.</div></div>
